...
#print(f"{player_name} has {player_health} health, and {player_attack} attack\n")
...
def battle(player_health, player_attack):
    ...
    print(f"\nA {enemy} appears: It has {enemy_health} health and {enemy_attack} attack.")
